...
class ErrorsFormatter:
    ...
    def format(self):
        if hasattr(self.exception, "get_full_details"):
            ...
            formatted_errors = self.__get_response_json_from_error_message(
    ...
    def __get_response_json_from_error_message(
    ...
    def __get_list_of_errors(self, field_path="", errors_dict={}):
        ...
        for key, value in errors_dict.items():
            ...
            if type(value) is list:
                ...
                current_level_error_list = self.__get_list_of_errors(
